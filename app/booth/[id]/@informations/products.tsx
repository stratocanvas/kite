									...
									{product?.map((product: any) => (
										<CarouselItem key={product._id} className="basis-auto pl-3">
											<Card className="w-[290px] h-[100%] flex flex-col">
												...
												<CardHeader>
													<CardDescription>
														{product.artist.length > 2
															? `${product.artist[0].name}, ${
																	product.artist[1].name
												...
												<CardContent className="flex-grow -mt-2 flex items-start justify-start overflow-x-auto"></CardContent>
												<CardFooter className="flex items-center overflow-x-auto mt-auto"></CardFooter>
											</Card>
										</CarouselItem>
									))}
								</CarouselContent>
