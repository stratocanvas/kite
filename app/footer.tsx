                    ...
                    <div className="flex justify-between items-center xl:px-96">
                        <CardTitle className="text-md">
                            <svg width="620" height="175" viewBox="0 0 620 175" fill="currentcolor" xmlns="http://www.w3.org/2000/svg" className="w-auto h-5">
                                ...
                                <path fillRule="evenodd" clipRule="evenodd" d="M170 2H0V150.753L74.3734 76.3794L74.3765 76.3763L74.3796 76.3794L95.5725 76.4334L95.6265 97.6263L95.6304 97.6302L21.2606 172H170V2Z" />
                            </svg>
